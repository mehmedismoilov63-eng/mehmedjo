"""
GHOST Assistant - Quick Start Test
Simple voice test without API keys
"""
...
class QuickStart:
    """Quick start test for voice commands"""
...
def main():
    """Main function"""
    try:
        print("👻 GHOST Assistant - Quick Start")
        print("🎤 Ovozli test rejimi")
        print()
